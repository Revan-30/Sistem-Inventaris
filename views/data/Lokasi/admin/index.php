...
<div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Data Lokasi</h1>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700">Kode Lokasi</th>
                    <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700">Nama Lokasi</th>
            ...
            <tbody class="divide-y divide-gray-100 bg-white">
                ...
                <tr class="transition hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3 font-medium text-gray-700"><?= htmlspecialchars($row['kode_lokasi'] ?? '', ENT_QUOTES, 'UTF-8') ?></td>
                    <td class="px-4 py-3 text-gray-700"><?= htmlspecialchars($row['nama_lokasi'] ?? '', ENT_QUOTES, 'UTF-8') ?></td>
                    <td class="px-4 py-3 text-gray-700"><?= htmlspecialchars($row['keterangan'] ?? '', ENT_QUOTES, 'UTF-8') ?></td>
                    <td class="px-4 py-3">
                        <div class="flex justify-center gap-2">
                            ...
                            <button
                                onclick="openEditModal(
                                    ...
                                    '<?= htmlspecialchars($row['kode_lokasi'] ?? '', ENT_QUOTES, 'UTF-8') ?>',
...
<div id="tambahModal"
    ...
    <div id="tambahModalContent"
        ...
        <form action="<?= BASE_URL ?>proses/lokasi/tambah.php" method="POST" class="space-y-4">

            <input type="text" name="kode_lokasi" placeholder="Kode Lokasi"
...
<div id="editModal"
    ...
    <div id="editModalContent"
        ...
        <form action="<?= BASE_URL ?>proses/lokasi/edit.php" method="POST" class="space-y-4">

            <input type="hidden" name="id" id="edit_id">

            <input type="text" name="kode_lokasi" id="edit_kode_lokasi"
                   class="w-full rounded-lg border px-3 py-2" required>

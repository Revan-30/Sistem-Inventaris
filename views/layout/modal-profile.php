...
<div id="profileModal"
    ...
    <div id="profileModalContent"
         class="
             w-full max-w-md scale-95 rounded-2xl bg-white opacity-0 shadow-xl
        ...
        <div class="flex items-center justify-between border-b border-gray-100 px-6 py-4">
            ...
            <button
                ...
                class="
                    flex h-8 w-8 items-center justify-center rounded-lg text-xl
        ...
        <div class="px-6 py-6">
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="
                    flex h-20 w-20 items-center justify-center rounded-2xl bg-blue-600
                ...
                <span class="
                    mt-1 rounded-full bg-blue-50 px-3 py-1 text-xs font-medium capitalize
                    text-blue-600">
        ...
        <div class="space-y-3 px-6 py-6">
            ...
            <button
                ...
                class="
                    ...
                    border-gray-100 px-4 py-4 text-left transition hover:border-blue-100
                    hover:bg-blue-50/40"
            >
                ...
                <span class="
                    text-lg text-gray-300 transition group-hover:translate-x-0.5
